...
test("invoice mail is signed by Stefan Dirnberger and can remind", () => {
  ...
  const followup = documentCorrespondence(invoice, DEFAULT_COMPANY, "https://client-lead-center.vercel.app", "followup");
  assert.match(followup.subject, /Nachfrage/);
});
